...
-- USER_TABLES : 사용자가 가지고 있는 테이블들의 전반적인 구조를 확일할 수 있는 시스템 테이블
...
INSERT INTO MEM_CHECK(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, GENDER, EMAIL, MEM_DATE) VALUES(3, 'user03', 'pass03', '곽병현', '남', 'asdf@1234', SYSDATE);
...
INSERT INTO MEM_PRI(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, GENDER, EMAIL, MEM_DATE) VALUES(1, 'user03', 'pass03', '곽병현', '남', 'asdf@1234', SYSDATE);
SELECT * FROM MEM_PRI;
...
INSERT INTO MEM_PRI(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, GENDER, EMAIL, MEM_DATE) VALUES(MEM_SEQ.NEXTVAL, 'user03', 'pass03', '곽병현', '남', 'asdf@1234', SYSDATE);
SELECT * FROM MEM_PRI;
...
INSERT INTO MEM_PRI2(MEM_ID, MEM_PWD, MEM_NAME, GENDER, EMAIL, MEM_DATE) VALUES('user03', 'pass03', '곽병현', '남', 'asdf@1234', SYSDATE);
...
DELETE FROM MEM_MEMBER2 WHERE GRADE_ID = 1;
...
INSERT INTO PUBLISHER(PUB_NAME, PHONE) VALUES('오픈도어북스', '010-1234-5678');
INSERT INTO PUBLISHER(PUB_NAME, PHONE) VALUES('알라딘', '010-4567-5678');
...
SELECT MEMBER_ID, BK_TITLE, PUB_NAME, RENT_NO
FROM RENT R
...
/*
        2-3. 제약조건명 변경
        RENAME CONSTRAINT 기존제약조건명 TO 변경할 재약조건명;
*/
ALTER TABLE DEPT_COPY
RENAME CONSTRAINT SYS_C008382 TO DEPT_ID_PK;
