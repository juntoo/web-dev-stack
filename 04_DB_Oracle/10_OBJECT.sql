...
-- 프로시저명 : SEL_EMP_ID, 변수명 EID - IN, ENAME - OUT, SAL - OUT
...
INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO) VALUES(400, '강성모', '0202');
...
FOR EACH ROW
BEGIN
    DBMS_OUTPUT.PUT_LINE('변경 전 : ' || :OLD.EMP_NAME || '  => 변경 후 : ' || :NEW.EMP_NAME);
END;
/
...
CREATE OR REPLACE TRIGGER PUT_PRO
...
INSERT INTO TB_PRODETAIL(PCODE, AMOUNT, STATUS) VALUES(3, 20, '입고');
